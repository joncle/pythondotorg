...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobContractType'
        db.create_table('jobs_jobcontracttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True)),
        ))
        db.send_create_signal('jobs', ['JobContractType'])

        # Adding field 'Job.contract_type'
        db.add_column('jobs_job', 'contract_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='jobs', null=True, to=orm['jobs.JobContractType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'JobContractType'
        db.delete_table('jobs_jobcontracttype')

        # Deleting field 'Job.contract_type'
        db.delete_column('jobs_job', 'contract_type_id')
    ...
    models = {
        ...
        'jobs.job': {
            ...
            'contact': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True', 'null': 'True'}),
            'contract_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'jobs'", 'null': 'True', 'to': "orm['jobs.JobContractType']"}),
            ...
            'job_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'related_name': "'jobs'", 'to': "orm['jobs.JobType']"}),
        ...
        'jobs.jobcontracttype': {
            'Meta': {'object_name': 'JobContractType', 'ordering': "('name',)"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True'})
        },
